							...
							addresses.map(function (address, index) {
								return _react2.default.createElement(
									...
									_react2.default.createElement(
										_Table.TableRowColumn,
										{ width: 80 },
										_react2.default.createElement(_FlatButton2.default, { onTouchTap: handleEdit(address._id), label: '\u67E5\u770B/\u7F16\u8F91', primary: true })
									),
									_react2.default.createElement(
										_Table.TableRowColumn,
										{ width: 80 },
										_react2.default.createElement(_FlatButton2.default, { onTouchTap: handleDelete(address._id), label: '\u5220\u9664', secondary: true })
									)
								);
							})
						)
