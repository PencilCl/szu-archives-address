	...
	var AddressTable = function (_Component) {
		...
		function AddressTable() {
			...
			return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = AddressTable.__proto__ || Object.getPrototypeOf(AddressTable)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
				currentPage: 1
			}, _this.changePage = function (page) {}, _temp), _possibleConstructorReturn(_this, _ret);
		}
		...
		_createClass(AddressTable, [{
			...
			value: function render() {
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement(_Pagination2.default, { changePage: this.changePage, currentPage: this.state.currentPage, totlePage: Math.floor(addresses.length / ROWS) }),
					addresses.length > 1 ? _react2.default.createElement(_Pagination2.default, { changePage: this.changePage, currentPage: this.state.currentPage, totlePage: Math.floor(addresses.length / ROWS) }) : null
				);
			}
		}]);
