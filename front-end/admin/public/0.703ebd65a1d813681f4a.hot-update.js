		...
		_createClass(AddressTable, [{
			...
			value: function render() {
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement(_Pagination2.default, { changePage: this.changePage, currentPage: this.state.currentPage, totlePage: addresses.length / 10 }),
					addresses.length > 1 ? _react2.default.createElement(_Pagination2.default, { changePage: this.changePage, currentPage: this.state.currentPage, totlePage: addresses.length / 10 }) : null
				);
			}
		}]);
